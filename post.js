...
window.onload = ()=>{
    ...
    const ddd = convertURLtoFile("http://127.0.0.1:8000/media/temp/7c00f7f1c6514183a59cdb089b856022_TempImage_object_None.jpg")
    ddd.then(data =>console.log(11111, data)) // 콘솔 성공
